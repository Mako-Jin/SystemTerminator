 ...
 */
@Getter
public class ResourceInfoEntity extends AbstractAggregate<ResourceId> {

    private ResourceInfoEntity(ResourceId resourceId, ResourcesIdentity identity) {
        super(resourceId);
    ...
    public static ResourceInfoEntity build(
        ...
        ResourcesIdentity identity = ResourcesIdentity.of(
                resourceValue,
                ResourceTypeEnums.fromCode(resourceType),
                requestUrl,
                requestMethod
        );
        // 创建实体
    ...
    public ResourceInfoEntity upgrade(ResourceInfoEntity newResourceEntity) {
        Version newVersion = calculateNewVersion(newResourceEntity);
        ResourceInfoEntity upgraded = new ResourceInfoEntity(this.getId(), newResourceEntity.getIdentity());
        // 3. 复制新数据
    ...
    private Version calculateNewVersion (ResourceInfoEntity newResourceEntity) {
    ...
    public boolean isSameAs(ResourceInfoEntity other) {
