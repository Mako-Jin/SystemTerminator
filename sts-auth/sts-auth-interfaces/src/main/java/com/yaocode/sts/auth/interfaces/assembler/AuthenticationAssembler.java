...
public interface AuthenticationAssembler {
     ...
     */
    @Mapping(target = "grantType", source = "credential.grantType")
    @Mapping(target = "username", source = "credential.username")
    @Mapping(target = "password", source = "credential.password")
    @Mapping(target = "phoneNum", source = "credential.phoneNum")
    @Mapping(target = "verifyCode", source = "credential.verifyCode")
    @Mapping(target = "rememberMe", source = "credential.rememberMe")
    @Mapping(target = "captcha", source = "credential.captcha")
    @Mapping(target = "captchaKey", source = "credential.captchaKey")
    @Mapping(target = "state", source = "credential.state")
    @Mapping(target = "scope", source = "credential.scope")
    @Mapping(target = "clientId", source = "credential.clientId")
    @Mapping(target = "clientType", source = "credential.clientType")
    @Mapping(target = "clientVersion", source = "credential.clientVersion")
    @Mapping(target = "deviceId", source = "credential.deviceId")
    @Mapping(target = "deviceType", source = "credential.deviceType")
    @Mapping(target = "countryCode", source = "credential.countryCode")
    @Mapping(target = "smsSessionId", source = "credential.smsSessionId")
    @Mapping(target = "autoRegister", source = "credential.autoRegister")
