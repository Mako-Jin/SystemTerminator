package com.yaocode.sts.flow.core.handler;

import com.yaocode.sts.flow.core.enums.NodeTypeEnums;
import com.yaocode.sts.flow.core.executor.ExecutionContext;
import com.yaocode.sts.flow.core.model.SequenceDefinition;
...
//        }
    ...
    public int getNodeType() {
        return NodeTypeEnums.PARALLEL_GATEWAY.getCode();
    }
}
