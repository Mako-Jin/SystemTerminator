...
import com.yaocode.sts.file.application.model.command.PresignedUrlCommand;
import com.yaocode.sts.file.application.model.query.BatchDownloadResultQuery;
import com.yaocode.sts.file.application.model.query.BatchDownloadTaskQuery;
import com.yaocode.sts.file.application.model.query.CrossOriginDownloadQuery;
import com.yaocode.sts.file.application.model.query.DirectDownloadQuery;
import com.yaocode.sts.file.application.model.query.DownloadHistoryQuery;
import com.yaocode.sts.file.application.model.query.DownloadRankingQuery;
import com.yaocode.sts.file.application.model.query.DownloadStatisticsQuery;
import com.yaocode.sts.file.application.model.query.EncryptedDownloadQuery;
import com.yaocode.sts.file.application.model.query.FileResourceQuery;
import com.yaocode.sts.file.application.model.query.FileVersionResourceQuery;
import com.yaocode.sts.file.application.model.query.MediaInfoQuery;
import com.yaocode.sts.file.application.model.query.PdfPageQuery;
import com.yaocode.sts.file.application.model.query.PreviewQuery;
import com.yaocode.sts.file.application.model.query.RangeDownloadQuery;
import com.yaocode.sts.file.application.model.query.StreamDownloadQuery;
import com.yaocode.sts.file.application.model.query.ThumbnailQuery;
import com.yaocode.sts.file.application.model.query.TokenDownloadQuery;
import com.yaocode.sts.file.application.model.result.BatchDownloadTaskResult;
import com.yaocode.sts.file.application.model.result.CrossOriginDownloadInfoResult;
import com.yaocode.sts.file.application.model.result.DownloadRecordResult;
import com.yaocode.sts.file.application.model.result.DownloadTokenResult;
import com.yaocode.sts.file.application.model.result.FileDownloadRankResult;
import com.yaocode.sts.file.application.model.result.FileDownloadStatisticsResult;
import com.yaocode.sts.file.application.model.result.MediaInfoResult;
import com.yaocode.sts.file.application.model.result.RangeDownloadResult;
import com.yaocode.sts.file.application.service.FileDownloadService;
