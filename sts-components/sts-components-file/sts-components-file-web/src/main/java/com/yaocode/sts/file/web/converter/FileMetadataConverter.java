...
import com.yaocode.sts.file.application.model.command.SetFilePublicCommand;
import com.yaocode.sts.file.application.model.command.UpdateDescriptionCommand;
import com.yaocode.sts.file.application.model.command.UpdateFileNameCommand;
import com.yaocode.sts.file.application.model.command.UpdateMetadataCommand;
import com.yaocode.sts.file.application.model.command.UpdatePermissionCommand;
import com.yaocode.sts.file.application.model.command.UpdateTagsCommand;
import com.yaocode.sts.file.application.model.dto.PermissionItemDto;
import com.yaocode.sts.file.application.model.query.AccessInfoQuery;
import com.yaocode.sts.file.application.model.query.FileCompareQuery;
import com.yaocode.sts.file.application.model.query.FileDetailQuery;
import com.yaocode.sts.file.application.model.query.FileExistenceQuery;
import com.yaocode.sts.file.application.model.query.FileInfoBatchQuery;
import com.yaocode.sts.file.application.model.query.FileInfoQuery;
import com.yaocode.sts.file.application.model.query.FileListQuery;
import com.yaocode.sts.file.application.model.query.FileMetadataQuery;
import com.yaocode.sts.file.application.model.query.FileSearchQuery;
import com.yaocode.sts.file.application.model.query.FileTypeStatisticsQuery;
import com.yaocode.sts.file.application.model.query.IntegrityCheckQuery;
import com.yaocode.sts.file.application.model.query.MyFileListQuery;
import com.yaocode.sts.file.application.model.query.PermissionInfoQuery;
import com.yaocode.sts.file.application.model.query.RecentFileQuery;
import com.yaocode.sts.file.application.model.query.SimpleSearchQuery;
import com.yaocode.sts.file.application.model.query.StorageInfoQuery;
import com.yaocode.sts.file.application.model.query.TrendDataQuery;
import com.yaocode.sts.file.application.model.result.AccessInfoResult;
import com.yaocode.sts.file.application.model.result.AccessRecordResult;
import com.yaocode.sts.file.application.model.result.BatchUpdateResult;
import com.yaocode.sts.file.application.model.result.CompareDetailsResult;
import com.yaocode.sts.file.application.model.result.FileAuditLogResult;
import com.yaocode.sts.file.application.model.result.FileCompareResult;
import com.yaocode.sts.file.application.model.result.FileDetailInfoResult;
...
import com.yaocode.sts.file.application.model.result.FileTypeResult;
import com.yaocode.sts.file.application.model.result.FileTypeStatisticsResult;
import com.yaocode.sts.file.application.model.result.FileVersionInfoResult;
import com.yaocode.sts.file.application.model.result.IntegrityCheckResult;
import com.yaocode.sts.file.application.model.result.PermissionInfoResult;
import com.yaocode.sts.file.application.model.result.SizeDistributionResult;
import com.yaocode.sts.file.application.model.result.SizeRangeResult;
import com.yaocode.sts.file.application.model.result.StorageInfoResult;
